...
/*
	static Inner Class : 외부 클래스에서 인스턴스 필드, 인스턴스 메소드는 static Inner class 블락에 올 수 없다
		외부 클래스의 정적 필드, 정적 메소드만 static Inner Class 블락에 올 수 있다.
		
		인스턴스 필드, 인스턴스 메소드는 객체 생성후 사용 가능
		정적 필드, 정적 메소드는 객체 생성하지 않고 바로 사용 가능
...
public class InnerClass_static {
	...
	public static void main(String[] args) {
		//static 이너 클래스의 객체 생성 : 외부 클래스를 생성하지 않고 바로 객체생성이 가능
