...
class A {
	...
	//생성자 : 필드의 내용을 초기화 할때 사용(일반적으로), 객체를 생성할 때 생성자를 반드시 호출해야 한다.
	//리턴 타입이 존재하지 않는다. 
	...
	//메소드 : 함수, 호출시 작동됨
	//리턴 타입 메소드명(인풋매개변수){ 메소드 호출시 프로그램 실행코드 }
...
public class Object02 {
	...
	public static void main(String[] args) {
		...
		//자료형
		//클래스명 참조변수 = new A();
		// A : 클래스, 객체 자료형 , 동일한 패키지 내에 클래스가 존재할 때 import 없이 사용 가능
		// a : 참조변수(Stack(Heap의 주소) : Heap(핃드, 메소드 의 값)
