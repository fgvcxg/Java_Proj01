...
public class Read_Array_Data {
	...
	public static void main(String[] args) {
		...
		System.out.println(arr2.length);	//2차원 배열의 행의 갯수
		System.out.println(arr2[0].length);	//0행의 열의 갯수
		System.out.println(arr2[1].length);	//1행의 열의 갯수
