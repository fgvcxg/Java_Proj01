...
public class SingleGenericArgument {
	...
	public static void main(String[] args) {
		...
		MyClass<Pencil> pen1 = new MyClass();		//MyClass 를 Pencil 모양으로 만듦
		pen1.set(new Pencil());						//만든 pen1에 Pencil을 넣어서 만듦
		System.out.println(pen1.get().pencil);		
		//pen1에 있는 것(Pencil)을 get(갖고 와서)해서 거기에 있는 String(pencil)을 호출 한다
		
		//Banana 객체를 setter로 주입하고 값가져오기
		MyClass<Banana> ban1 = new MyClass();
		ban1.set(new Banana());
		System.out.println(ban1.get().banana);
