...
class Goods1{	//상품 클래스, Apple 상품을 담는 클래스
	//접근 제어자가 private 이기 때문에 외부에서 apple 참조 변수에 값을 넣거나 가져오기위해서는 
	//getter, setter를 통해서만 apple 참조변수에 값을 수정할 수 있다
	//getter : apple 참조변수의 값을 가져올때 사용
	//setter : apple 참조변수의 다른 값을 할당할 때 사용
...
public class ProblemsBeforeGeneric {
	...
	public static void main(String[] args) {
		...
		//1. Goods1을 총해서 Apple 객체를 추가하고 가져오기
		Goods1 goods1 = new Goods1();
		goods1.getApple();
		goods1.setApple(new Apple());	//setter 를 사용해서 Apple 객체를 추가함
